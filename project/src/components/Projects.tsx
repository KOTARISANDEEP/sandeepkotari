  ...
  const projects = [
    {
      ...
      technologies: ['React', 'Node.js', 'Firebase', 'SendGrid', 'REST APIs'],
      ...
      type: 'image',
      features: [
        'Food donation and surplus food rescue management',
        'City-based donor and volunteer matching',
        'Real-time status tracking (Accept → Pickup → Donate → Complete)',
        'Secure authentication and role-based access control',
        'Email notifications and alerts using SendGrid',
        'Admin dashboard for monitoring activities and approvals'
      ]
    },
    {
      title: 'Aranya Jal – AI-Powered Smart Agriculture Platform',
      description: 'AI-driven agriculture solution for crop analysis, disease detection, IoT-based field monitoring, and smart farming recommendations.',
      technologies: ['Python', 'TensorFlow', 'Keras', 'OpenCV', 'Node.js', 'Express.js', 'IoT'],
      image: '/assets/images/How to fix common Farming Simulator 17 issues.jpg',
      tags: ['#AIinAgriculture', '#ComputerVision', '#IoT', '#DeepLearning', '#SmartFarming'],
      github: '#',
      demo: '#',
      type: 'image'
    },
        ...
        >
          {projects.map((project, index) => (
            ...
            >
              ...
              >
                {/* Know More Button - For Hungry Saver (index 0) and Aranya Jal (index 1) - Above image container */}
                {(index === 0 || index === 1) && (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <Link to={index === 0 ? "/hungrysaver-information" : "/aranyajal-information"}>
                      <motion.button
                        className="px-4 py-2 bg-gradient-to-r from-electric-blue/20 to-neon-violet/20 text-white rounded-full text-sm font-semibold border border-electric-blue/30 hover-glow backdrop-blur-sm"
                ...
                <div className="relative group overflow-hidden rounded-2xl glass-morphism p-2">
                  <div className="relative">
                    ...
                    {index === 0 && (
                      <div className="absolute top-4 right-4 bg-soft-green/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 z-10">
                    ...
                    {(index === 1 || index === 2) && (
                      <div className="absolute top-4 right-4 bg-electric-blue/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 z-10">
                        <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
                        NEW
                      </div>
                    )}
              ...
              >
                <div className="glass-morphism p-8 rounded-2xl hover-glow">
                  ...
                  {/* Core Features - Only for first project */}
                  {project.features && (
                    <div className="mb-6">
                      <h4 className="text-lg font-bold mb-3 text-soft-green">🔧 Core Features</h4>
